##-----------------------------------------------------------------------
# Perform data integration on Cholangiocytes after cleansing (2nd iteration on dataset)
##-----------------------------------------------------------------------
...
seu <- subset(seu, idents = c("Cholangiocytes", "Cycling"), invert = FALSE)
