##-----------------------------------------------------------------------
# Perform data integration on Endothelia after whole
...
##-----------------------------------------------------------------------
opts$lineage_anno <- "Endothelia"

io <- list() # Input/Output
io$out_dir <- paste0(results_dir, opts$lineage_anno, "/01_integrate/00_iter1/")
...
opts$modules_group <- list(lineage = mouse_liver_lineage_markers,
                           endo_human_livreg = endo_human_livreg_markers)
